...
/**
 * Tests {@link ResourceCompilerTask}.
 *
 ...
 * @module
 */
public class ResourceCompilerTaskTest {
    /**
     * Tests {@link ResourceCompilerTask#filterLanguages(File[])}.
     */
    @Test
    public void testFilterLanguages() {
        ...
        assertEquals(2, ResourceCompilerTask.filterLanguages(files));
