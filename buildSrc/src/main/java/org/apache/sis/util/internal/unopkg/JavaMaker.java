 ...
 * by {@code javac}), which is why the usual Gradle resources mechanism doesn't fit.
 *
 ...
 * @module
 */
public class JavaMaker extends DefaultTask {
    /**
     ...
     */
    private File outputDirectory = new File(getProject().getBuildDir().getPath()+"/classes/java/main");;
