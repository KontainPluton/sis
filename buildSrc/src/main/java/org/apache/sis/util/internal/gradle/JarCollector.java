 ...
 * Dependencies are collected as well, except if already presents. This tasks uses hard links
...
public class JarCollector extends DefaultTask implements FileFilter {
    /**
     * The Gradle project running this plugin.
     */
     ...
     */
    private String rootDirectory = project.getRootDir().getPath();
