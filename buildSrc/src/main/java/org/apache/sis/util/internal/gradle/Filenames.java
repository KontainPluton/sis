...
final class Filenames {
     ...
     */
    static final String TARGET_DIRECTORY = "build";

    /**
     * The sub-directory inside {@value #TARGET_DIRECTORY} for binaries.
     */
    static final String BINARIES_DIRECTORY = "classes";
     ...
     */
    static final String ARTIFACT_PATH = "build";
     ...
     */
    static final String LIB_DIRECTORY = "libs";
     ...
     */
    static File distributionFile(final String rootDirectory, final String filename) throws GradleException {
        ...
        if (!outDirectory.isDirectory()) {
            if (!outDirectory.mkdir()) {
                throw new GradleException("Can't create the \"" + DISTRIBUTION_DIRECTORY + "\" directory.");
            }
        }
