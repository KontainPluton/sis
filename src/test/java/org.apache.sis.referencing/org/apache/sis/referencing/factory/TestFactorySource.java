...
public final strictfp class TestFactorySource {
     ...
     * This method differs from {@link org.apache.sis.testmetadata.sql.TestDatabase} by querying a permanent
     * database instead of a temporary database to be deleted after the tests.
     *
     * @see org.apache.sis.testmetadata.sql.TestDatabase#createOnPostgreSQL(String, boolean)
     */
