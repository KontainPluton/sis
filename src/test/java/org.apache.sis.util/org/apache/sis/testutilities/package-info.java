...
/**
 * Tools for SIS tests. This package defines a base class, {@link org.apache.sis.testutilities.TestCase},
 * which is extended directly or indirectly by most (but not all) SIS tests.
 * This package defines also an {@link org.apache.sis.testutilities.Assert} class which extend the GeoAPI
 ...
 *
 * <ul class="verbose">
 *   <li><b>{@code -Dorg.apache.sis.testutilities.verbose=true}</b><br>
 ...
 *
 *   <li><b>{@code -Dorg.apache.sis.testutilities.encoding=UTF-8}</b> (or any other valid encoding name)<br>
