 ...
 */
package org.apache.sis.testutilities;
...
public final strictfp class TestConfiguration extends Static {
    /**
     * The {@systemProperty org.apache.sis.testutilities.extensive} system property for enabling more extensive tests.
     ...
     */
    public static final String EXTENSIVE_TESTS_KEY = "org.apache.sis.testutilities.extensive";

    /**
     * The {@systemProperty org.apache.sis.testutilities.verbose} system property for enabling verbose outputs.
     * If this {@linkplain System#getProperties() system property} is set to {@code true},
     * then the content sent to the {@link TestCase#out} field will be printed after each test.
     */
    public static final String VERBOSE_OUTPUT_KEY = "org.apache.sis.testutilities.verbose";

    /**
     * The {@systemProperty org.apache.sis.testutilities.gui.show} system property
     * for enabling display of test images or widgets.
     */
    public static final String SHOW_WIDGET_KEY = "org.apache.sis.testutilities.gui.show";

    /**
     * The {@systemProperty org.apache.sis.testutilities.encoding} system property for setting the output encoding.
     ...
     */
    public static final String OUTPUT_ENCODING_KEY = "org.apache.sis.testutilities.encoding";
