 ...
 *     described in the {@linkplain org.apache.sis.testutilities package javadoc}.</li>
...
public abstract strictfp class TestCase {
     ...
     * {@value org.apache.sis.testutilities.TestConfiguration#VERBOSE_OUTPUT_KEY} system property
     * is set to {@code true}. This writer will use the system default encoding, unless
     * the {@value org.apache.sis.testutilities.TestConfiguration#OUTPUT_ENCODING_KEY} system
     * property has been set to a different value.
     *
     * @see org.apache.sis.testutilities.TestUtilities#forceFlushOutput()
     */
    ...
    /**
     * {@code true} if the {@value org.apache.sis.testutilities.TestConfiguration#VERBOSE_OUTPUT_KEY}
     * system property is set to {@code true}.
     */
    public static final boolean VERBOSE;

    /**
     * {@code true} if the {@value org.apache.sis.testutilities.TestConfiguration#EXTENSIVE_TESTS_KEY}
     * system property is set to {@code true}.
