...
public final strictfp class UUIDMarshallingTest extends TestCase {
     ...
     * elements are handled by {@link PropertyType}.
     *
    ...
    public void testIdentification() throws JAXBException {
        ...
        MetadataAssert.assertTitleEquals("Citation", "My data", citation);
        /*
        ...
        MetadataAssert.assertXmlEquals(IDENTIFIED_XML, actual, "xmlns:*");
     ...
     * {@code <cit:series>} element are handled by {@link PropertyType}.
     *
     * @throws JAXBException if an error occurred during (un)marshalling.
     */
    @Test
    public void testReference() throws JAXBException {
        ...
        MetadataAssert.assertTitleEquals("Citation.title", "My data", citation);
        /*
         * Programmatic verification of the Series properties,
         * which is the main object of interest in this test.
         */
    ...
    public void testReferenceInEmptyObject() throws JAXBException {
         ...
         */
        final String actual = XML.marshal(citation);
        MetadataAssert.assertXmlEquals(REFERENCED_XML, actual, "xmlns:*");
        assertEquals(citation, XML.unmarshal(actual));
    }
}
