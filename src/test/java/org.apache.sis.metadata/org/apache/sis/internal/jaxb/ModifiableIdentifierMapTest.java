...
public final strictfp class ModifiableIdentifierMapTest extends TestCase {
    ...
    public void testGetAndPut() {
         ...
         */
        assertTrue(identifiers.add(new IdentifierMapEntry(IdentifierSpace.ID,   "myID")));
        assertTrue(identifiers.add(new IdentifierMapEntry(IdentifierSpace.UUID, "myUUID")));
        ...
        assertTrue  ("Shall contain the entry we added.",        map.containsKey(IdentifierSpace.ID));
        assertTrue  ("Shall contain the entry we added.",        map.containsKey(IdentifierSpace.UUID));
        assertFalse ("Shall not contain entry we didn't added.", map.containsKey(IdentifierSpace.HREF));
        ...
        assertEquals("Shall contain the entry we added.",        "myID",   map.get(IdentifierSpace.ID));
        assertEquals("Shall contain the entry we added.",        "myUUID", map.get(IdentifierSpace.UUID));
        assertNull  ("Shall not contain entry we didn't added.",           map.get(IdentifierSpace.HREF));
        assertMapEquals("{gml:id=“myID”, gco:uuid=“myUUID”}", map);
        /*
         * Alter one entry (no new entry added).
         */
        assertEquals("Shall get the old value.",       "myUUID", map.put(IdentifierSpace.UUID, "myNewUUID"));
         ...
         */
        assertNull  ("Shall not contain entry we didn't added.", map.put(IdentifierSpace.HREF, "myHREF"));
        assertTrue  ("Shall contain the entry we added.",        map.containsValue("myHREF"));
        assertTrue  ("Shall contain the entry we added.",        map.containsKey(IdentifierSpace.HREF));
         ...
         */
        assertEquals("Shall get the old value.",   "myNewUUID", map.remove(IdentifierSpace.UUID));
        assertFalse ("Shall not contain the entry we removed.", map.containsValue("myNewUUID"));
        assertFalse ("Shall not contain the entry we removed.", map.containsKey(IdentifierSpace.UUID));
        ...
        assertFalse ("Shall not contain the entry we removed.", map.containsKey(IdentifierSpace.HREF));
         ...
         */
        assertTrue  (map.keySet().remove(IdentifierSpace.ID));
        assertFalse ("Shall not contain the entry we removed.", map.containsValue("myID"));
        assertFalse ("Shall not contain the entry we removed.", map.containsKey(IdentifierSpace.ID));
        assertMapEquals("{}", map);
    ...
    public void testPutSpecialized() {
        ...
        assertNull(map.putSpecialized(IdentifierSpace.ID,   myID));
        assertNull(map.putSpecialized(IdentifierSpace.UUID, myUUID));
        assertNull(map.putSpecialized(IdentifierSpace.HREF, myURI));
        assertMapEquals("{gml:id=“myID”,"
                + " gco:uuid=“a1eb6e53-93db-4942-84a6-d9e7fb9db2c7”,"
                + " xlink:href=“http://mylink”}", map);

        assertSame(myID,   map.getSpecialized(IdentifierSpace.ID));
        assertSame(myUUID, map.getSpecialized(IdentifierSpace.UUID));
        assertSame(myURI,  map.getSpecialized(IdentifierSpace.HREF));
        assertEquals("myID",                                 map.get(IdentifierSpace.ID));
        assertEquals("a1eb6e53-93db-4942-84a6-d9e7fb9db2c7", map.get(IdentifierSpace.UUID));
        assertEquals("http://mylink",                        map.get(IdentifierSpace.HREF));
    }
    ...
    public void testGetSpecialized() {
        ...
        assertNull(map.put(IdentifierSpace.UUID, "a1eb6e53-93db-4942-84a6-d9e7fb9db2c7"));
        assertNull(map.put(IdentifierSpace.HREF, "http://mylink"));
        assertMapEquals("{gml:id=“myID”,"
                + " gco:uuid=“a1eb6e53-93db-4942-84a6-d9e7fb9db2c7”,"
                + " xlink:href=“http://mylink”}", map);
        ...
        assertEquals("a1eb6e53-93db-4942-84a6-d9e7fb9db2c7",             map.get           (IdentifierSpace.UUID));
        assertEquals("http://mylink",                                    map.get           (IdentifierSpace.HREF));
        assertEquals("myID",                                             map.getSpecialized(IdentifierSpace.ID));
        assertEquals(URI.create("http://mylink"),                        map.getSpecialized(IdentifierSpace.HREF));
        assertEquals(fromString("a1eb6e53-93db-4942-84a6-d9e7fb9db2c7"), map.getSpecialized(IdentifierSpace.UUID));
    }
    ...
    public void testDuplicatedAuthorities() {
        final List<Identifier> identifiers = new ArrayList<>();
        assertTrue(identifiers.add(new IdentifierMapEntry(IdentifierSpace.ID,   "myID1")));
        assertTrue(identifiers.add(new IdentifierMapEntry(IdentifierSpace.UUID, "myUUID")));
        assertTrue(identifiers.add(new IdentifierMapEntry(IdentifierSpace.ID,   "myID2")));
        ...
        assertEquals("myID1",  map.get(IdentifierSpace.ID));
        assertEquals("myUUID", map.get(IdentifierSpace.UUID));

        final Iterator<Citation> it = map.keySet().iterator();
        assertTrue(it.hasNext());
        assertSame(IdentifierSpace.ID, it.next());
        it.remove();
        assertTrue(it.hasNext());
        assertSame(IdentifierSpace.UUID, it.next());
