...
public final strictfp class PropertyTypeTest extends TestCase {
     ...
     */
    private final org.apache.sis.internal.jaxb.gco.PropertyTypeMock.Value metadata = new org.apache.sis.internal.jaxb.gco.PropertyTypeMock.Value();

    /**
     * Simulates the marshalling of the {@link #metadata} value.
     */
    private org.apache.sis.internal.jaxb.gco.PropertyTypeMock marshal() {
        /*
         ...
         */
        return new org.apache.sis.internal.jaxb.gco.PropertyTypeMock().marshal(metadata);
    }
    ...
    public void testWithNoReference() throws Exception {
        final org.apache.sis.internal.jaxb.gco.PropertyTypeMock property = marshal();
    ...
    private void testWithUUID(final boolean useReferenceResolverMock) throws Exception {
        ...
        if (!useReferenceResolverMock) {
            ...
            assertNull("org/apache/sis/metadata", property.metadata);
