 ...
 */
package org.apache.sis.testmetadata.xml;
...
import org.apache.sis.testmetadata.xml.DocumentComparator;
...
public abstract strictfp class TestCase extends org.apache.sis.testutilities.TestCase {
    ...
    {
        MetadataAssert.assertXmlEquals(getResource(filename), marshal(object), ignoredAttributes);
    }
    ...
    {
        MetadataAssert.assertXmlEquals(getResource(filename), marshal(object, metadataVersion), ignoredAttributes);
    }
    ...
    {
        MetadataAssert.assertXmlEquals(getResource(filename), marshal(object, metadataVersion), tolerance, ignoredNodes, ignoredAttributes);
    }
