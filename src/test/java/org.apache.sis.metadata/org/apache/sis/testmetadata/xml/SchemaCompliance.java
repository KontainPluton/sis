...
import org.apache.sis.testmetadata.xml.PackageVerifier;
...
public final strictfp class SchemaCompliance extends SchemaInformation {
     ...
     * {@link org.apache.sis.testmetadata.xml.PackageVerifier} convenience, as a way to share a single map for all verifier instances.</p>
     */
    ...
    {
        org.apache.sis.testmetadata.xml.PackageVerifier verifier = null;
            ...
            for (Path path : stream) {
                ...
                if (!filename.startsWith(".")) {
                    if (Files.isDirectory(path)) {
                        ...
                        if (verifier == null) {
                            verifier = new org.apache.sis.testmetadata.xml.PackageVerifier(this, c.getPackage());
                        }
                        verifier.verify(c);
                    }
                }
