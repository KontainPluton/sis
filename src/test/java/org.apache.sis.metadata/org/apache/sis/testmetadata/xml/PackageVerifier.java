...
import org.apache.sis.testmetadata.xml.InfiniteSet;
...
import static org.apache.sis.testutilities.TestCase.PENDING_FUTURE_SIS_VERSION;
...
final strictfp class PackageVerifier {
    ...
    private static final Set<String> ALL = org.apache.sis.testmetadata.xml.InfiniteSet.INSTANCE;
     ...
     * we had to keep the namespace declared in {@link DefaultScopedName}
