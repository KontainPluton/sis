 ...
 * This test is actually invoked by {@link org.apache.sis.metadata.sql.MetadataSourceTest} in order to opportunistically use
...
public final strictfp class MetadataFallbackVerifier {
     ...
     * of {@code sis-metadata} module, the test will rather be executed by {@link org.apache.sis.metadata.sql.MetadataSourceTest} for
    ...
    public void compare() throws Exception {
        try (TestDatabase db = TestDatabase.create("MetadataSource");
             MetadataSource source = new MetadataSource(MetadataStandard.ISO_19115, db.source, "org/apache/sis/metadata", null))
        {
            source.install();
            compare(source);
        }
