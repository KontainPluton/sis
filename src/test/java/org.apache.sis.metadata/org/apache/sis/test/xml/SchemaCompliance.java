...
import org.apache.sis.test.xml.PackageVerifier;
...
public final strictfp class SchemaCompliance extends SchemaInformation {
     ...
     * {@link org.apache.sis.test.xml.PackageVerifier} convenience, as a way to share a single map for all verifier instances.</p>
     */
    ...
    {
        org.apache.sis.test.xml.PackageVerifier verifier = null;
            ...
            for (Path path : stream) {
                ...
                if (!filename.startsWith(".")) {
                    if (Files.isDirectory(path)) {
                        ...
                        if (verifier == null) {
                            verifier = new org.apache.sis.test.xml.PackageVerifier(this, c.getPackage());
                        }
                        verifier.verify(c);
                    }
                }
