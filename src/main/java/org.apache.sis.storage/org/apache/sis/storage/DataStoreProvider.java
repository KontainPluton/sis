...
public abstract class DataStoreProvider {
     ...
     * Consequently {@link InputStream} and {@link java.nio.channels.Channel} should be avoided.</p>
     *
     * @see #CREATE
     ...
     * Marks are available as {@link ByteBuffer#mark()}, {@link InputStream#mark(int)}
     * and {@link ImageInputStream#mark()}.
     ...
     *
     * <blockquote>
     * {@link ByteBuffer} (default byte order fixed to {@link java.nio.ByteOrder#BIG_ENDIAN BIG_ENDIAN}),
     * {@link InputStream},
     * {@link java.io.DataInput},
     * {@link ImageInputStream} and
     * {@link Reader}.
     * </blockquote>
     *
     ...
     * (for example an {@link InputStream}).
     *
