...
public final class IdentifiedObjects extends Static {
     ...
     *   <tr><td>{@value IdentifiedObject#NAME_KEY}</td>
     *       <td>{@link IdentifiedObject#getName()}</td></tr>
     *   <tr><td>{@value IdentifiedObject#ALIAS_KEY}</td>
     *       <td>{@link IdentifiedObject#getAlias()}</td></tr>
     *   <tr><td>{@value IdentifiedObject#IDENTIFIERS_KEY}</td>
     *       <td>{@link IdentifiedObject#getIdentifiers()}</td></tr>
     *   <tr><td>{@value IdentifiedObject#REMARKS_KEY}</td>
     *       <td>{@link IdentifiedObject#getRemarks()}</td></tr>
     *   <tr><td>{@value CoordinateOperation#SCOPE_KEY}</td>
     *       <td>{@link CoordinateOperation#getScope()} (also in datum and reference systems)</td></tr>
     *   <tr><td>{@value CoordinateOperation#DOMAIN_OF_VALIDITY_KEY}</td>
     *       <td>{@link CoordinateOperation#getDomainOfValidity()} (also in datum and reference systems)</td></tr>
     *   <tr><td>{@value CoordinateOperation#OPERATION_VERSION_KEY}</td>
     *       <td>{@link CoordinateOperation#getOperationVersion()}</td></tr>
     *   <tr><td>{@value CoordinateOperation#COORDINATE_OPERATION_ACCURACY_KEY}</td>
     ...
     *       <td>{@link org.apache.sis.referencing.AbstractIdentifiedObject#isDeprecated()}</td></tr>
     * </table>
     *
     ...
     * This method checks first the {@linkplain org.apache.sis.referencing.AbstractIdentifiedObject#getName() primary name},
     * then all {@linkplain org.apache.sis.referencing.AbstractIdentifiedObject#getAlias() aliases} in their iteration order.
     *
     * <ul class="verbose">
     ...
     *
     * @see org.apache.sis.referencing.AbstractIdentifiedObject#getName()
     */
     ...
     * This method checks all {@linkplain org.apache.sis.referencing.AbstractIdentifiedObject#getIdentifiers() identifiers} in their iteration
     ...
     *         has been found.
     *
     * @see org.apache.sis.referencing.AbstractIdentifiedObject#getIdentifier()
     */
     ...
     * <code>object.{@linkplain org.apache.sis.referencing.AbstractIdentifiedObject#getIdentifiers() getIdentifiers()}</code>. If there is none,
     * then this method fallback on <code>object.{@linkplain org.apache.sis.referencing.AbstractIdentifiedObject#getName() getName()}</code>.
     ...
     *
     * <ul>
     *   <li><code>object.{@linkplain org.apache.sis.referencing.AbstractIdentifiedObject#getName() getName()}</code></li>
     *   <li><code>object.{@linkplain org.apache.sis.referencing.AbstractIdentifiedObject#getAlias() getAlias()}</code> in iteration order</li>
     *   <li><code>object.{@linkplain org.apache.sis.referencing.AbstractIdentifiedObject#getIdentifiers() getIdentifiers()}</code> in iteration order</li>
     * </ul>
     *
     ...
     * {@linkplain org.apache.sis.referencing.AbstractIdentifiedObject#getName() name},
     * {@linkplain org.apache.sis.referencing.AbstractIdentifiedObject#getAlias() alias} or
     * {@linkplain org.apache.sis.referencing.AbstractIdentifiedObject#getIdentifiers() identifier}, in that order.
            ...
            throws NoSuchAuthorityFactoryException, FactoryException
    {
        ...
        if (authority == null) {
            factory = org.apache.sis.referencing.AuthorityFactories.ALL;
        } else {
            factory = org.apache.sis.referencing.AuthorityFactories.ALL.getAuthorityFactory(GeodeticAuthorityFactory.class, authority, null);
        }
        return factory.newIdentifiedObjectFinder();
    }

    /**
     * Returns {@code true} if either the {@linkplain org.apache.sis.referencing.AbstractIdentifiedObject#getName() primary name} or at least
     * one {@linkplain org.apache.sis.referencing.AbstractIdentifiedObject#getAlias() alias} matches the given string according heuristic rules.
     * If the given object is an instance of {@link org.apache.sis.referencing.AbstractIdentifiedObject}, then this method delegates to its
     * {@link org.apache.sis.referencing.AbstractIdentifiedObject#isHeuristicMatchForName(String) isHeuristicMatchForName(String)} method
     ...
     *
     * <ul>
     *   <li>The {@linkplain org.apache.sis.referencing.AbstractIdentifiedObject#getName() primary name}'s {@linkplain NamedIdentifier#getCode() code}
     *       (without {@linkplain NamedIdentifier#getCodeSpace() codespace}).</li>
     *   <li>Any {@linkplain org.apache.sis.referencing.AbstractIdentifiedObject#getAlias() alias}'s {@linkplain NamedIdentifier#tip() tip}
    ...
    public static boolean isHeuristicMatchForName(final IdentifiedObject object, final String name) {
        ...
        if (object instanceof org.apache.sis.referencing.AbstractIdentifiedObject) {
            /*
     ...
     *   <tr><td>{@link CoordinateOperation}</td> <td>{@code coordinateOperation}</td> <td>Coordinate operation definition</td></tr>
