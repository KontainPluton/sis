...
/**
 * Implementation of {@link org.apache.sis.referencing.AbstractIdentifiedObject} methods that require knowledge about subclasses.
 ...
 * <ul>
 *   <li>{@link org.apache.sis.referencing.AbstractIdentifiedObject#castOrCopy(IdentifiedObject)}</li>
 * </ul>
 *
...
final class SubTypes {
     ...
     */
    static org.apache.sis.referencing.AbstractIdentifiedObject castOrCopy(final IdentifiedObject object) {
         ...
         */
        if (object == null || object instanceof org.apache.sis.referencing.AbstractIdentifiedObject) {
            return (org.apache.sis.referencing.AbstractIdentifiedObject) object;
        }
