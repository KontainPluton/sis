...
public enum CommonCRS {
    ...
    public static CommonCRS forDatum(final CoordinateReferenceSystem crs) {
        ...
        if (crs instanceof SingleCRS) {
            ...
            if (single == null) {
                throw new IllegalArgumentException(Resources.format(
                        Resources.Keys.NonHorizontalCRS_1, org.apache.sis.referencing.IdentifiedObjects.getDisplayName(crs, null)));
            }
        }
        ...
        throw new IllegalArgumentException(Errors.format(
                Errors.Keys.UnsupportedDatum_1, org.apache.sis.referencing.IdentifiedObjects.getDisplayName(datum, null)));
    }
    ...
    static CommonCRS forDatum(final GeodeticDatum datum) {
         ...
         */
        int epsg = 0;
        final Identifier identifier = org.apache.sis.referencing.IdentifiedObjects.getIdentifier(datum, Citations.EPSG);
        if (identifier != null) {
        ...
        if (object == null) {
            synchronized (this) {
                ...
                if (object == null) {
                    ...
                    if (this == DEFAULT) {
                        cs = (EllipsoidalCS) org.apache.sis.referencing.StandardDefinitions.createCoordinateSystem(org.apache.sis.referencing.StandardDefinitions.ELLIPSOIDAL_2D, true);
                    } else {
                        cs = DEFAULT.geographic().getCoordinateSystem();
                    }
                    object = org.apache.sis.referencing.StandardDefinitions.createGeographicCRS(geographic, datum(), cs);
                    cached = object;
                }
            }
        }
        ...
        if (object == null) {
            synchronized (this) {
                ...
                if (object == null) {
                    ...
                    final EllipsoidalCS cs;
                    if (this == DEFAULT) {
                        cs = (EllipsoidalCS) org.apache.sis.referencing.StandardDefinitions.createCoordinateSystem(org.apache.sis.referencing.StandardDefinitions.ELLIPSOIDAL_3D, true);
                    } else {
        ...
        if (object == null) {
            synchronized (this) {
                ...
                if (object == null) {
                    ...
                    if (this == DEFAULT) {
                        cs = (CartesianCS) org.apache.sis.referencing.StandardDefinitions.createCoordinateSystem(org.apache.sis.referencing.StandardDefinitions.EARTH_CENTRED, true);
                    } else {
            ...
            synchronized (this) {
                ...
                if (object == null) {
                    ...
                    if (this == DEFAULT) {
                        final GeodeticAuthorityFactory factory = factory();
                        if (factory != null) try {
                            cs = factory.createSphericalCS(Short.toString(org.apache.sis.referencing.StandardDefinitions.SPHERICAL));
                        } catch (FactoryException e) {
                            failure(this, "spherical", e, org.apache.sis.referencing.StandardDefinitions.SPHERICAL);
                        }
                        if (cs == null) {
                            cs = (SphericalCS) org.apache.sis.referencing.StandardDefinitions.createCoordinateSystem(org.apache.sis.referencing.StandardDefinitions.SPHERICAL, true);
                        }
                    } else {
                    ...
                    // Use same name and datum than the geographic CRS.
                    final GeographicCRS base = geographic();
                    object = new DefaultGeocentricCRS(org.apache.sis.referencing.IdentifiedObjects.getProperties(base, exclude()), base.getDatum(), cs);
        ...
        if (object == null) {
            synchronized (this) {
                ...
                if (object == null) {
                    ...
                    object = org.apache.sis.referencing.StandardDefinitions.createGeodeticDatum(datum, ellipsoid(), primeMeridian());
                    cached = object;
                }
            }
        }
            ...
            synchronized (this) {
                ...
                if (object == null) {
                    if (this == NAD83) {
                        ...
                        object = org.apache.sis.referencing.StandardDefinitions.createEllipsoid(ellipsoid);
                    }
                    cached = object;
                }
            }
            ...
            synchronized (this) {
                ...
                if (object == null) {
                    if (this != DEFAULT) {
                        ...
                        final GeodeticAuthorityFactory factory = factory();
                        if (factory != null) try {
                            cached = object = factory.createPrimeMeridian(org.apache.sis.referencing.StandardDefinitions.GREENWICH);
                            return object;
                        } catch (FactoryException e) {
                            failure(this, "primeMeridian", e, Constants.EPSG_GREENWICH);
                        }
                        object = org.apache.sis.referencing.StandardDefinitions.primeMeridian();
                    }
                    cached = object;
                }
            }
        ...
        if (crs == null) {
            ...
            if (cs == null) {
                if (this != DEFAULT) {
                    ...
                    cs = (CartesianCS) org.apache.sis.referencing.StandardDefinitions.createCoordinateSystem(
                            isUTM   ? org.apache.sis.referencing.StandardDefinitions.CARTESIAN_2D :
                            isSouth ? org.apache.sis.referencing.StandardDefinitions.UPS_SOUTH
                                    : org.apache.sis.referencing.StandardDefinitions.UPS_NORTH, true);
                }
            }
            crs = org.apache.sis.referencing.StandardDefinitions.createUniversal(code, geographic(), isUTM, latitude, longitude, cs);
                ...
                synchronized (this) {
                    ...
                    if (object == null) {
                        if (isEPSG) {
                            ...
                            object = org.apache.sis.referencing.StandardDefinitions.createVerticalCRS(crs, datum());
                        } else {
                            final VerticalCS cs = cs();
                            object = new DefaultVerticalCRS(org.apache.sis.referencing.IdentifiedObjects.getProperties(cs, exclude()), datum(), cs);
                        }
                        cached = object;
                    }
                }
                ...
                synchronized (this) {
                    ...
                    if (object == null) {
                        if (isEPSG) {
                            ...
                            object = org.apache.sis.referencing.StandardDefinitions.createVerticalDatum(datum);
                        } else {
                ...
                synchronized (this) {
                    ...
                    if (object == null) {
                        ...
                        if (this == JAVA) {
                            ...
                            properties = org.apache.sis.referencing.IdentifiedObjects.getProperties(datum, exclude());
                        }
        ...
        private TimeCS cs() {
            ...
            switch (this) {
                ...
                case UNIX: {
                    ...
                    cs   = org.apache.sis.referencing.IdentifiedObjects.getProperties(share, exclude());
                    axis = org.apache.sis.referencing.IdentifiedObjects.getProperties(share.getAxis(0), exclude());
                    break;
                }
                case JAVA: {
            ...
            if (crs == null) {
                ...
                switch (this) {
                    case GEODISPLAY: {
                        ...
                        properties.put(EngineeringCRS.NAME_KEY, new org.apache.sis.referencing.NamedIdentifier(Citations.WMS, "1"));
                        break;
                    }
                    case DISPLAY: {
     ...
     *
     * @param  key  a constant from {@link Vocabulary.Keys}.
    ...
    static Map<String,?> properties(final InternationalString name) {
        return singletonMap(NAME_KEY, new org.apache.sis.referencing.NamedIdentifier(null, name));
    }
    ...
    static GeodeticAuthorityFactory factory() {
        if (!org.apache.sis.referencing.EPSGFactoryFallback.FORCE_HARDCODED) {
            final GeodeticAuthorityFactory factory = org.apache.sis.referencing.AuthorityFactories.EPSG();
            if (!(factory instanceof org.apache.sis.referencing.EPSGFactoryFallback)) {
                return factory;
            }
        }
        return null;
    ...
    static void failure(final Object caller, final String method, final FactoryException e, final int code) {
        ...
        if (!(e instanceof UnavailableFactoryException) || org.apache.sis.referencing.AuthorityFactories.failure((UnavailableFactoryException) e)) {
