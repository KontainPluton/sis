 ...
 *
 * <ul class="verbose">
 *   <li><b>{@linkplain org.apache.sis.referencing.AbstractIdentifiedObject#getName() Name}:</b><br>
 ...
 *
 *   <li><b>{@linkplain org.apache.sis.referencing.AbstractIdentifiedObject#getAlias() Aliases}:</b><br>
 ...
 *
 *   <li><b>{@linkplain org.apache.sis.referencing.AbstractIdentifiedObject#getIdentifiers() Identifiers}:</b><br>
 ...
 *
 *   <li><b>{@linkplain org.apache.sis.referencing.ImmutableIdentifier#getCodeSpace() Code space}:</b><br>
 ...
 *
 *   <li><b>{@linkplain org.apache.sis.referencing.ImmutableIdentifier#getVersion() Version}:</b><br>
 ...
 *
 *   <li><b>{@linkplain org.apache.sis.referencing.ImmutableIdentifier#getDescription() Description}:</b><br>
 ...
 *
 *   <li><b>{@linkplain org.apache.sis.referencing.AbstractIdentifiedObject#getRemarks() Remarks}:</b><br>
 ...
 * <ul>
 *   <li>
 *     {@linkplain org.apache.sis.referencing.NamedIdentifier#getAuthority() Authority},
 *     {@linkplain org.apache.sis.referencing.NamedIdentifier#getCodeSpace() code space} and
 *     {@linkplain org.apache.sis.referencing.NamedIdentifier#getVersion()   version}:<br>
 ...
 *     {@linkplain org.apache.sis.referencing.ImmutableIdentifier#getDescription()      description} and
 *     {@linkplain org.apache.sis.referencing.AbstractIdentifiedObject#getRemarks()     remarks}:<br>
...
public abstract class Builder<B extends Builder<B>> {
     ...
     * {@value IdentifiedObject#NAME_KEY},
     * {@value IdentifiedObject#ALIAS_KEY},
     * {@value IdentifiedObject#IDENTIFIERS_KEY} and
     * {@value IdentifiedObject#REMARKS_KEY} keys.
     ...
     * This object is built from the {@value Identifier#CODESPACE_KEY} value when first needed.
     */
     ...
     * {@linkplain org.apache.sis.referencing.IdentifiedObjects#getProperties(IdentifiedObject, String...) here}.
     *
    ...
    private GenericName createName(final Citation authority, final CharSequence name) {
        if (authority == getAuthority()) {
            ...
            return new org.apache.sis.referencing.NamedIdentifier(authority, name);
        }
    }
    ...
    private Identifier createIdentifier(final Citation authority, final String codeSpace, final String identifier, final String version) {
        if (isDeprecated()) {
            ...
            return new org.apache.sis.referencing.ImmutableIdentifier(authority, codeSpace, identifier, version, getDescription());
        }
    }

    /**
     * Converts the given name into an identifier. Note that {@link org.apache.sis.referencing.NamedIdentifier}
    ...
    private static Identifier toIdentifier(final GenericName name) {
        return (name instanceof Identifier) ? (Identifier) name : new org.apache.sis.referencing.NamedIdentifier(name);
    }
     ...
     * @see org.apache.sis.referencing.ImmutableIdentifier#getCodeSpace()
     */
     ...
     * {@linkplain org.apache.sis.referencing.AbstractIdentifiedObject#getName() primary name}, and
     * all subsequent invocations add an {@linkplain org.apache.sis.referencing.AbstractIdentifiedObject#getAlias() alias}.
     *
     ...
     * {@linkplain org.apache.sis.referencing.AbstractIdentifiedObject#getAlias() aliases} defined after the primary name.
     *
     * <div class="note"><b>Example:</b>
        ...
        if (!isDeprecated && properties.get(IdentifiedObject.NAME_KEY) != null) {
            ...
            if (isDeprecated) {
                ...
                properties.put(IdentifiedObject.NAME_KEY,
                        new org.apache.sis.referencing.NamedIdentifier(authority, codeSpace, name, version, getDescription()));
            }
        }
        return self();
    }
     ...
     * <h4>Name and aliases</h4>
     * This method can be invoked many times. The first invocation sets the
     * {@linkplain org.apache.sis.referencing.AbstractIdentifiedObject#getName() primary name} to the given value, and
     * all subsequent invocations add an {@linkplain org.apache.sis.referencing.AbstractIdentifiedObject#getAlias() alias}.
     *
     * <p><b>Lifetime:</b>
     * the name and all aliases are cleared after a {@code createXXX(…)} method has been invoked.</p>
    ...
    public B addName(final Identifier name) {
        ...
        if (properties.putIfAbsent(IdentifiedObject.NAME_KEY, name) != null) {
            // A primary name is already present. Add the given name as an alias instead.
            aliases.add(name instanceof GenericName ? (GenericName) name : new org.apache.sis.referencing.NamedIdentifier(name));
        }
        return self();
    }
    ...
    private boolean isDeprecated() {
        return Boolean.TRUE.equals(properties.get(org.apache.sis.referencing.AbstractIdentifiedObject.DEPRECATED_KEY));
    }
    ...
    public B setDeprecated(final boolean deprecated) {
        properties.put(org.apache.sis.referencing.AbstractIdentifiedObject.DEPRECATED_KEY, deprecated);
        return self();
    }
