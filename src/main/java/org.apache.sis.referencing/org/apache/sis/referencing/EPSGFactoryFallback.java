        ...
        implements CRSAuthorityFactory, CSAuthorityFactory, DatumAuthorityFactory
{
    ...
    public Set<String> getAuthorityCodes(Class<? extends IdentifiedObject> type) {
        ...
        if (pm) codes.add(org.apache.sis.referencing.StandardDefinitions.GREENWICH);
        ...
        if (type.isAssignableFrom(EllipsoidalCS.class)) {
            add(codes, org.apache.sis.referencing.StandardDefinitions.ELLIPSOIDAL_2D);
            add(codes, org.apache.sis.referencing.StandardDefinitions.ELLIPSOIDAL_3D);
        }
        if (type.isAssignableFrom(SphericalCS.class)) {
            add(codes, org.apache.sis.referencing.StandardDefinitions.SPHERICAL);
        }
        if (type.isAssignableFrom(CartesianCS.class)) {
            add(codes, org.apache.sis.referencing.StandardDefinitions.EARTH_CENTRED);
            add(codes, org.apache.sis.referencing.StandardDefinitions.CARTESIAN_2D);
            add(codes, org.apache.sis.referencing.StandardDefinitions.UPS_NORTH);
            add(codes, org.apache.sis.referencing.StandardDefinitions.UPS_SOUTH);
        }
    ...
    private Object predefined(String code, final int kind) throws NoSuchAuthorityCodeException {
        try {
            ...
            if ((kind & CS) != 0) {
                final CoordinateSystem cs = org.apache.sis.referencing.StandardDefinitions.createCoordinateSystem(n, false);
                if (cs != null) return cs;
            }
            if ((kind & AXIS) != 0) {
                final CoordinateSystemAxis axis = org.apache.sis.referencing.StandardDefinitions.createAxis(n, false);
