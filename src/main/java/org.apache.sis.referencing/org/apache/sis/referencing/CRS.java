...
public final class CRS extends Static {
     ...
     *   <tr><td>CRS:27</td>    <td>{@link org.apache.sis.referencing.CommonCRS#NAD27  NAD27}</td>  <td>Geographic</td>      <td>Like EPSG:4267 except for (<var>longitude</var>, <var>latitude</var>) axis order</td></tr>
     *   <tr><td>CRS:83</td>    <td>{@link org.apache.sis.referencing.CommonCRS#NAD83  NAD83}</td>  <td>Geographic</td>      <td>Like EPSG:4269 except for (<var>longitude</var>, <var>latitude</var>) axis order</td></tr>
     *   <tr><td>CRS:84</td>    <td>{@link org.apache.sis.referencing.CommonCRS#WGS84  WGS84}</td>  <td>Geographic</td>      <td>Like EPSG:4326 except for (<var>longitude</var>, <var>latitude</var>) axis order</td></tr>
     *   <tr><td>EPSG:4230</td> <td>{@link org.apache.sis.referencing.CommonCRS#ED50   ED50}</td>   <td>Geographic</td>      <td>European Datum 1950</td></tr>
     *   <tr><td>EPSG:4258</td> <td>{@link org.apache.sis.referencing.CommonCRS#ETRS89 ETRS89}</td> <td>Geographic</td>      <td>European Terrestrial Reference Frame 1989</td></tr>
     *   <tr><td>EPSG:4267</td> <td>{@link org.apache.sis.referencing.CommonCRS#NAD27  NAD27}</td>  <td>Geographic</td>      <td>North American Datum 1927</td></tr>
     *   <tr><td>EPSG:4269</td> <td>{@link org.apache.sis.referencing.CommonCRS#NAD83  NAD83}</td>  <td>Geographic</td>      <td>North American Datum 1983</td></tr>
     *   <tr><td>EPSG:4322</td> <td>{@link org.apache.sis.referencing.CommonCRS#WGS72  WGS72}</td>  <td>Geographic</td>      <td>World Geodetic System 1972</td></tr>
     *   <tr><td>EPSG:4326</td> <td>{@link org.apache.sis.referencing.CommonCRS#WGS84  WGS84}</td>  <td>Geographic</td>      <td>World Geodetic System 1984</td></tr>
     *   <tr><td>EPSG:4936</td> <td>{@link org.apache.sis.referencing.CommonCRS#ETRS89 ETRS89}</td> <td>Geocentric</td>      <td>European Terrestrial Reference Frame 1989</td></tr>
     *   <tr><td>EPSG:4937</td> <td>{@link org.apache.sis.referencing.CommonCRS#ETRS89 ETRS89}</td> <td>Geographic 3D</td>   <td>European Terrestrial Reference Frame 1989</td></tr>
     *   <tr><td>EPSG:4978</td> <td>{@link org.apache.sis.referencing.CommonCRS#WGS84  WGS84}</td>  <td>Geocentric</td>      <td>World Geodetic System 1984</td></tr>
     *   <tr><td>EPSG:4979</td> <td>{@link org.apache.sis.referencing.CommonCRS#WGS84  WGS84}</td>  <td>Geographic 3D</td>   <td>World Geodetic System 1984</td></tr>
     *   <tr><td>EPSG:4984</td> <td>{@link org.apache.sis.referencing.CommonCRS#WGS72  WGS72}</td>  <td>Geocentric</td>      <td>World Geodetic System 1972</td></tr>
     *   <tr><td>EPSG:4985</td> <td>{@link org.apache.sis.referencing.CommonCRS#WGS72  WGS72}</td>  <td>Geographic 3D</td>   <td>World Geodetic System 1972</td></tr>
     *   <tr><td>EPSG:5041</td> <td>{@link org.apache.sis.referencing.CommonCRS#WGS84  WGS84}</td>  <td>Projected</td>       <td>WGS 84 / UPS North (E,N)</td></tr>
     *   <tr><td>EPSG:5042</td> <td>{@link org.apache.sis.referencing.CommonCRS#WGS84  WGS84}</td>  <td>Projected</td>       <td>WGS 84 / UPS South (E,N)</td></tr>
     *   <tr><td>EPSG:322##</td><td>{@link org.apache.sis.referencing.CommonCRS#WGS72  WGS72}</td>  <td>Projected</td>       <td>WGS 72 / UTM zone ##N</td></tr>
     *   <tr><td>EPSG:323##</td><td>{@link org.apache.sis.referencing.CommonCRS#WGS72  WGS72}</td>  <td>Projected</td>       <td>WGS 72 / UTM zone ##S</td></tr>
     *   <tr><td>EPSG:326##</td><td>{@link org.apache.sis.referencing.CommonCRS#WGS84  WGS84}</td>  <td>Projected</td>       <td>WGS 84 / UTM zone ##N</td></tr>
     *   <tr><td>EPSG:327##</td><td>{@link org.apache.sis.referencing.CommonCRS#WGS84  WGS84}</td>  <td>Projected</td>       <td>WGS 84 / UTM zone ##S</td></tr>
     *   <tr><td>EPSG:5715</td> <td>{@link org.apache.sis.referencing.CommonCRS.Vertical#DEPTH DEPTH}</td> <td>Vertical</td> <td>Mean Sea Level depth</td></tr>
     *   <tr><td>EPSG:5714</td> <td>{@link org.apache.sis.referencing.CommonCRS.Vertical#MEAN_SEA_LEVEL MEAN_SEA_LEVEL}</td> <td>Vertical</td> <td>Mean Sea Level height</td></tr>
     * </table></blockquote>
     *
     * <h4>URI forms</h4>
     ...
     * {@linkplain DefaultConversion conversion} and a
     ...
     * The {@link org.apache.sis.referencing.IdentifiedObjects#lookupURN(IdentifiedObject, Citation)} method can be seen
            ...
            throws NoSuchAuthorityCodeException, FactoryException
    {
        ...
        try {
            return org.apache.sis.referencing.AuthorityFactories.ALL.createCoordinateReferenceSystem(code);
        } catch (UnavailableFactoryException e) {
            return org.apache.sis.referencing.AuthorityFactories.fallback(e).createCoordinateReferenceSystem(code);
        }
    }
            ...
            throws FactoryException
    {
        ...
        try {
            ...
            if (org.apache.sis.referencing.AuthorityFactories.failure(e)) {
                throw e;
            } else try {
     ...
     * This method can also extract the {@linkplain org.apache.sis.referencing.CommonCRS.Vertical#ELLIPSOIDAL ellipsoidal height}
            ...
            if (intersect == current) {
                ...
                if (datum instanceof GeodeticDatum) {
                    ...
                    if (AxisDirections.isVertical(verticalAxis.getDirection())) try {
                        addTo.add(new org.apache.sis.referencing.EllipsoidalHeightSeparator((GeodeticDatum) datum, isVertical).separate((SingleCRS) crs));
                        selected &= ~current;
        ...
        switch (horizontalCode(crs)) {
            ...
            case 3: {
                ...
                if (crs instanceof ProjectedCRS) {
                    ...
                    fromBase = new DefaultConversion(org.apache.sis.referencing.IdentifiedObjects.getProperties(fromBase),
...
check:  while (lower != 0 || upper != dimension) {
    ...
    public static CRSAuthorityFactory getAuthorityFactory(final String authority) throws FactoryException {
        if (authority == null) {
            return org.apache.sis.referencing.AuthorityFactories.ALL;
        }
        return org.apache.sis.referencing.AuthorityFactories.ALL.getAuthorityFactory(CRSAuthorityFactory.class, authority, null);
    }
