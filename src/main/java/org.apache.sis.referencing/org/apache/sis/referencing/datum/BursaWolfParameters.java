...
public class BursaWolfParameters extends FormattableObject implements Cloneable, Serializable {
     ...
     * to the {@linkplain MatrixSIS#inverse() inverse}
     ...
     * {@link MatrixSIS#inverse()} in order to increase the chances
     ...
     *
     * <ul>
     *   <li>The matrix shall be {@linkplain MatrixSIS#isAffine() affine}.</li>
