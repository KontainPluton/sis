 ...
 *   </tr>
 *   <tr>
 *     <td>{@value IdentifiedObject#NAME_KEY}</td>
 *     <td>{@link Identifier} or {@link String}</td>
 *     <td>{@link AbstractIdentifiedObject#getName()}</td>
 *   </tr>
 *   <tr>
 *     <td>{@value Identifier#AUTHORITY_KEY}</td>
...
public class GeodeticObjectFactory extends AbstractFactory implements CRSFactory, CSFactory, DatumFactory, Parser {
     ...
     * map have precedence, even if their {@linkplain Map.Entry#getValue() value} is {@code null}
     ...
     * warnings may be reported in a {@linkplain Logger logger} named {@code "org.apache.sis.io.wkt"}.
