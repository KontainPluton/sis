 ...
 * This base class does not hold any state and does not implement the {@link Serializable}
...
public abstract class AbstractEnvelope extends FormattableObject implements Envelope, Emptiable {
     ...
     * {@linkplain RangeMeaning#WRAPAROUND wraparound} range is found.
     ...
     * and their CRS must be {@linkplain ComparisonMode#APPROXIMATE approximately equal}.
