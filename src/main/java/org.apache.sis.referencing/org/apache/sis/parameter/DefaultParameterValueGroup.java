 ...
 *
 * <ul>
 *   <li>{@link #parameter(String)} is similar in purpose to {@link Map#get(Object)},
 *       with an additional level of indirection in both the argument and the return value.</li>
 *   <li>{@link #values()} is similar in purpose to {@link Map#entrySet()},
...
public class DefaultParameterValueGroup extends Parameters implements LenientComparable, Serializable {
     ...
     * {@link InvalidParameterCardinalityException} or other runtime exceptions if a condition
     * is not met.
     *
