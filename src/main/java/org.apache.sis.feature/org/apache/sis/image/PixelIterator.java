 ...
 * implementations exist for a few commonly used {@linkplain SampleModel sample models}.
 *
...
public class PixelIterator {
     ...
     * image uses {@link SinglePixelPackedSampleModel}, in which case the number of bits per
