...
public class MetadataStandard implements Serializable {
     ...
     * property associated to the given key is a {@link Collection} but the given value is a single
     * element (not a collection), then the given value is {@linkplain Collection#add(Object) added}
     ...
     * }
     *
     * Nodes can be removed by invoking the {@link Iterator#remove()} method on the
     * {@linkplain TreeTable.Node#getChildren() children} iterator.
     ...
     * This is a similar contract than {@link Set#hashCode()} (except for the interface)
