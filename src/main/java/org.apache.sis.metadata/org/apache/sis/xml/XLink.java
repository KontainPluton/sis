 ...
 * <tr>
 *   <th> </th>
 *   <th style="width: 14%">{@link Type#SIMPLE simple}</th>
 *   <th style="width: 14%">{@link Type#EXTENDED extended}</th>
 *   <th style="width: 14%">{@link Type#LOCATOR locator}</th>
 *   <th style="width: 14%">{@link Type#ARC arc}</th>
 *   <th style="width: 14%">{@link Type#RESOURCE resource}</th>
 *   <th style="width: 14%">{@link Type#TITLE title}</th>
 * </tr>
...
public class XLink implements Serializable {
     ...
     * The bit values are defined in the {@link Type#fieldMask} javadoc.
     */
     ...
     * </ul>
     *
     * The default value is {@code null}. If the {@link #setType(Type)} method has been
     ...
     *
     * @param  field  the attribute code, as documented in {@link Type#fieldMask}.
