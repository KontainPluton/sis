 ...
 * Each {@linkplain Entry map entry} is associated to an {@link Identifier} where
 * {@linkplain Entry#getKey() key} is the {@linkplain Identifier#getAuthority()
 * identifier authority} and the {@linkplain Entry#getValue() value} is the
