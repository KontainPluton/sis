...
public class DBFRecordBasedResultSet extends DBFResultSet {
    ...
    /**
     * @see org.apache.sis.internal.shapefile.jdbc.resultset.AbstractResultSet#getBigDecimal(String)
    ...
    /**
     * @see org.apache.sis.internal.shapefile.jdbc.resultset.AbstractResultSet#getInt(String)
     * @throws SQLConnectionClosedException if the connection is closed.
     * @throws SQLNoSuchFieldException if the field looked for doesn't exist.
     * @throws SQLNotNumericException if the field value is not numeric.
     */
    ...
    /**
     * @see org.apache.sis.internal.shapefile.jdbc.resultset.DBFResultSet#getObject(String)
     */
    @Override
